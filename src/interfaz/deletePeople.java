...
public class deletePeople extends javax.swing.JFrame {
    ...
    public deletePeople(Persona p) {
        ...
        for(int i=0;i<ap.size();i++){
            ...
            if(!pp.getRut().equals(user.getRut())){
                subida=(pp.getNombre()+" "+pp.getApellidoP()+", "+pp.getRut());
    ...
    private void Actualizar(){
        ...
        for(int i=0;i<ap.size();i++){
            Persona pp = (Persona)ap.get(i);
            if(!pp.getRut().equals(user.getRut())){
                subida=pp.getNombre()+" "+pp.getApellidoP()+" "+pp.getApellidoM()+", "+pp.getRut();
                modeloLista.addElement(pp.getNombre()+" "+pp.getApellidoP()+" "+pp.getApellidoM()+", "+pp.getRut());
                map.put(subida, pp);
            }
        }
        initComponents();
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        Persona pp = (Persona)mapa.get(piv);
        ListaPersonas lp = ListaPersonas.getInstance();
        lp.eliminarP(pp);
        this.Actualizar();
