...
public class MenuCertDef extends javax.swing.JFrame {
    Persona p;
    public MenuCertDef(Persona p) {
        initComponents();
        this.p=p;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese el Rut del Difunto:");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(70, 70, 70)
                .addComponent(texto, javax.swing.GroupLayout.PREFERRED_SIZE, 231, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        CertDefunsion c=new CertDefunsion();
        c.menuDef(p, texto.getText());
