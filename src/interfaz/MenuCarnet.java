...
public class MenuCarnet extends javax.swing.JFrame {
    
    public MenuCarnet(Persona p) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El Gobierno De Chile le informa que su solicitud de emisión de carnet");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("está siendo procesada, se solicita verificar periodicamente el estado");
